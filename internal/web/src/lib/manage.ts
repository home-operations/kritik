...
import type { ManagementErrorCode, PathDetails } from './types';

const hints: Partial<Record<ManagementErrorCode, string>> = {
  ...
  actions_disabled: 'Dashboard actions are not available on this server yet.',
...
export function describe(err: unknown): string {
  ...
  const hint = hints[err.code as ManagementErrorCode];
